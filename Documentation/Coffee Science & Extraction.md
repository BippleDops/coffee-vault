...
**Color Change**:
- Green/yellow → tan → light brown → medium brown → dark brown → black
...
**Maillard Reaction** (300-400°F / 150-200°C):
- Amino acids + reducing sugars → melanoidins (brown compounds)
- Creates hundreds of flavor compounds
- Non-enzymatic browning
- Develops coffee flavor complexity

**Caramelization** (~340°F / 170°C):
- Sucrose breaks down
...
**Hotter Water** (195-205°F / 90-96°C):
- ↑ Solubility of compounds
- ↑ Extraction speed
- ↑ Extraction total
- Best for: Light roasts, under-extracting

**Cooler Water** (185-195°F / 85-90°C):
- ↓ Solubility
- ↓ Extraction speed
- ↓ Bitterness
...
**Optimal Range**: 195-205°F (90-96°C) for most methods
...
**Example**:
- 20g coffee → 300g brew @ 1.35% TDS
- Extraction = (300 × 1.35) / 20 = 20.25% ✅ Good!
...
- Sour + Strong = Under-extracted, enough coffee → grind finer
- Bitter + Weak = Over-extracted, too little coffee → use more coffee
- Bitter + Strong = Over-extracted → grind coarser

---

## 🌡️ Water Chemistry Deep Dive

### Why Water Matters

**Coffee is 98-99% Water**:
- Water quality determines ceiling of cup quality
- Bad water → can't make good coffee
- Good water → necessary but not sufficient
...
- SCAA Standard: 17-85 ppm as CaCO₃
...
## 📊 Extraction Variables Matrix

### The Extraction Matrix

| Variable | Increase → Effect | Decrease → Effect |
|----------|-------------------|-------------------|
| **Grind Size (finer)** | ↑ Extraction | ↓ Extraction |
| **Temperature** | ↑ Extraction | ↓ Extraction |
| **Time** | ↑ Extraction | ↓ Extraction |
| **Agitation** | ↑ Extraction | ↓ Extraction |
| **Coffee Dose** | ↑ Strength (not extraction %) | ↓ Strength |
| **Water Amount** | ↓ Strength (not extraction %) | ↑ Strength |
...
**Acids** (Brightness):
- Citric acid → lemon, citrus
- Malic acid → apple, pear
- Acetic acid → vinegar (small amounts OK)
- Chlorogenic acids → brightness, astringency
- Quinic acid → bitterness (develops over time in brewed coffee)

**Sugars** (Sweetness):
- Sucrose (breaks down during roasting)
- Fructose → fruit sweetness
- Glucose → sweetness
- Caramelized sugars → toffee, caramel
...
- Trigonelline → bitterness, converts to niacin (vitamin B3)
...
- Linalool → lavender
- Geraniol → floral, sweet

**Fruity**:
- Esters → berry, fruit
- Furanones → strawberry, caramel
- Aldehydes → apple, almond

**Nutty/Chocolate**:
- Pyrazines → roasted, nutty, earthy
- Melanoidins → chocolate, caramel
- Furans → caramel, sweet
...
## 🎓 Brewing Method Extraction Comparison
...
**Science-Focused**:
- *The Physics of Filter Coffee* by Jonathan Gagné (comprehensive physics)
...
- [Jonathan Gagné - Coffee Ad Astra](https://coffeeadastra.com/) - Physics of coffee
...
## 📊 Track Your Extraction Learning
